...
from .config import DEFAULT_MRAG_DIR, ExperimentConfig, RetrieverConfig, load_experiment_config
from .data import load_qa_items
from .qa_sets import load_qa_ids_file
...
def main(argv: list[str] | None = None) -> int:
    ...
    add_upstream_export_args(parser)
...
def upstream_export_from_args(args: argparse.Namespace) -> dict[str, Any]:
    export_request = _export_request_from_args(args)
    return export_upstream_inputs(
...
def add_upstream_export_args(parser: argparse.ArgumentParser) -> None:
